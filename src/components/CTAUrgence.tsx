...
export default function CTAUrgence({ variant = 'section', className = '' }: CTAUrgenceProps) {
  ...
  if (variant === 'hero') {
    return (
      <div className={`hero-cta-desktop ${className}`}>
        <div className="bg-gradient-to-r from-urgent-red to-urgent-red-dark rounded-2xl p-8 shadow-2xl">
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <div className="bg-white rounded-full p-4 animate-bounce-phone">
                <Phone className="w-8 h-8 text-urgent-red" />
              </div>
            </div>
  ...
  return (
    <div className={`bg-urgent-red text-white rounded-xl p-6 text-center ${className}`}>
      ...
      <button
        onClick={handleCall}
        className="bg-white text-urgent-red px-6 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors w-full"
      >
